...
class RainProviderTest {
    ...
    private val backing = mockk<TurnkeyProvider>()
    private val provider = RainProvider(backing)
    ...
    fun `the config maps onto the backing configuration field for field`() {
        ...
        val address = "0xAbCdEf0000000000000000000000000000000001"
        ...
        // The address goes through untouched: no lowercasing, checksumming or trimming.
        assertThat(mapped.walletAddress).isSameInstanceAs(address)
