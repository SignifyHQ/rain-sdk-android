...
| **`RainWalletConfig`** | Behaviour of the Rain wallet provider: `sessionPolicy`, `onSessionExpired`, `sponsorGas`. No address override. See [Rain wallet provider](#rain-wallet-provider). |
